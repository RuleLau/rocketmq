...
public class SendMessageProcessor extends AbstractSendMessageProcessor implements NettyRequestProcessor {
    ...
    /**
     *  Consumer 消费某条消息失败时，会调用该接口发回消息。Broker 会存储发回的消息。这样下次 Consumer 拉取该消息，
     *  能够从 CommitLog 和 ConsumeQueue 顺序读取。
     *  因为大多数逻辑和 Broker 接收普通消息 很相似的时候 标记成独有的逻辑。
     * @param ctx
     * @param request
     * @return
